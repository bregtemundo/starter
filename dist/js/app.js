...
},{"./flickity":9,"fizzy-ui-utils":4,"unidragger":28}],9:[function(require,module,exports){
// Flickity main
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":9,"fizzy-ui-utils":4,"tap-listener":27}],13:[function(require,module,exports){
// player & autoPlay
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":9,"fizzy-ui-utils":4,"tap-listener":27}],15:[function(require,module,exports){
// slide
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"gsap":17,"scrollmagic":22}],24:[function(require,module,exports){
/*!
 * ScrollMagic v2.0.5 (2015-04-29)
 * The javascript library for magical scroll interactions.
 * (c) 2015 Jan Paepke (@janpaepke)
...
},{"scrollmagic":22}],25:[function(require,module,exports){
...
},{"ev-emitter":3}],30:[function(require,module,exports){
...
var App = function () {
  ...
  _createClass(App, [{
    key: '_createModules',
    value: function _createModules() {
      this.example = new _Example2.default();
    }
  }, {
    key: '_startFontLoader',
    value: function _startFontLoader() {
    ...
    value: function _startTransitions() {
      var transitionManager = new _TransitionManager2.default();
    }
  }, {
    key: '_startScroll',
    value: function _startScroll() {
      this.scrollManager = new _ScrollManager2.default(true);
    }
  }, {
    key: '_startNavigation',
    value: function _startNavigation() {
...
},{"./modules/Example":32,"./modules/Navigation":33,"modules/ScrollManager":34,"transitions/TransitionManager":36,"utils/environment":37,"webfontloader":30}],32:[function(require,module,exports){
(function (global){
"use strict";
...
var Example = function () {
  function Example(options) {
    ...
    _environment.$document.on('initModules', function (event) {
      if (_this.isActive()) {
        _this.init();
      }
    });
  ...
  _createClass(Example, [{
    ...
    value: function isActive() {
      ...
      if (_environment.$body.hasClass('page-node-type-project') || _environment.$body.hasClass('path-contact')) {
        return true;
      }
      return false;
    }
    ...
    value: function init() {
      // Set events
      (0, _jquery2.default)('.block-page-title-block').on('click', this.onTitleClick);

      //set functionality
      this.images = new _flickity2.default('.field--type-image');
      this.initScroll();
    }
  }, {
    key: "destroy",
    value: function destroy() {
      ...
      (0, _jquery2.default)('.block-page-title-block').off('click');
    ...
    value: function initScroll() {
      ...
      // build scenes
      new ScrollMagic.Scene({ triggerElement: ".page-title", triggerHook: 1, offset: 0, reverse: false }).setClassToggle(".page-title", "active")
      //.addIndicators()
      .addTo(controller);

      new ScrollMagic.Scene({ triggerElement: ".field--type-image", duration: 300, triggerHook: 1, offset: 0 }).addTo(controller).on("progress", function (e) {
        //scroll progress
        var scrollProgress = e.progress.toFixed(3);
        var totalImages = _this2.images.cells.length;
        var percentPerImage = 1 / totalImages;
        var activeIndex = Math.round(scrollProgress / percentPerImage);

        _this2.images.select(activeIndex);
      });

      // build tween
      var tween = new _gsap.TimelineMax().add([TweenMax.to(".node__meta", 10, { y: "-40", ease: _gsap.Linear.easeNone }),
      //TweenMax.to(".node__content", 10, {y: "-10px", ease: Linear.easeNone}),
      TweenMax.to(".block-page-title-block", 10, { y: "-60px", skewY: "-10deg", color: '#ccff00', ease: _gsap.Linear.easeNone })]);

      new ScrollMagic.Scene({ triggerElement: "article.node--type-project", duration: '100%', triggerHook: 1 }).setTween(tween).addIndicators().addTo(controller);
    }
  }, {
    key: "onTitleClick",
    value: function onTitleClick(e) {
      console.log("click title");
      TweenMax.to(".field--name-title", 10, { text: { value: "quality, bespoke content", padSpace: true, ease: _gsap.Linear.easeNone }, ease: _gsap.Linear.easeNone });
    }
  }]);
...
},{"../utils/environment":37,"animation.gsap":23,"debug.addIndicators":24,"flickity":10,"gsap":17,"scrollmagic":22}],33:[function(require,module,exports){
(function (global){
"use strict";
...
var Navigation = function () {
  ...
  _createClass(Navigation, [{
    ...
    value: function isActive() {
      ...
      if ((0, _jquery2.default)('.menu--main').length) {
        return true;
      }
      return false;
    }
    ...
    value: function initMobileNavigation() {
      ...
      // setup mmenu
      this.mobileMenu = (0, _jquery2.default)(".menu--main").mmenu(
      //options
      {
        extensions: ["pagedim"],
        offCanvas: {
        ...
        navbar: false,
        slidingSubmenus: false }).data('mmenu');

      //add the toggle
      (0, _jquery2.default)("body").prepend('<a href="#" class="c-mmenu__toggle">menu</a>');
      (0, _jquery2.default)('.c-mmenu__toggle').on('click', function () {
        return _this.openCloseMobileNavigation();
      });
    }
  }, {
    key: "openCloseMobileNavigation",
    value: function openCloseMobileNavigation() {
      if (_environment.$html.hasClass('mm-opened')) {
        this.mobileMenu.close();
        (0, _jquery2.default)('.c-mmenu__toggle').removeClass('c-mmenu__toggle--close');
      } else {
        this.mobileMenu.open();
        (0, _jquery2.default)('.c-mmenu__toggle').addClass('c-mmenu__toggle--close');
      }
    }
  }, {
    key: "initDesktopNavigation",
    value: function initDesktopNavigation() {
      /*
       ...
       */
      this.desktopMenu = (0, _jquery2.default)(".menu--main > .menu").superfish({
        animation: {},
        animationOut: {},
        onBeforeShow: function onBeforeShow() {
          ...
          this.hideTimeout = setTimeout(function () {
            return _this2.addClass("sf-opening");
          }, 1);
          return false;
        },
        onBeforeHide: function onBeforeHide() {
          ...
          clearTimeout(this.hideTimeout);
          this.hideTimeout = setTimeout(function () {
            return _this3.removeClass("sf-opened");
      ...
      // add headroom.js
      this.headroom = new _headroom2.default((0, _jquery2.default)('header').get(0));

      // (doesn't work in combination with smooth-scrollbar)
      // overwrite attachEvent and getScrollY when working with smooth-scrollbar
      if (_environment.$window.app.scrollManager.useSmoothScroll) {
        this.headroom.scroller = _environment.$window.app.scrollManager.scrollbar;
        ...
        this.headroom.attachEvent = function () {
          ...
          if (!this.initialised) {
            this.lastKnownScrollY = this.getScrollY();
            this.initialised = true;
            this.scroller.addListener(function () {
              _this4.debouncer.handleEvent();
            });
...
},{"../utils/environment":37,"headroom":18,"jquery.mmenu":19,"match-media":21,"superfish":26}],34:[function(require,module,exports){
(function (global){
'use strict';
...
var ScrollManager = function () {
  function ScrollManager() {
    ...
    var useSmoothScroll = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  ...
  _createClass(ScrollManager, [{
    ...
    value: function init() {
      ...
      if (this.useSmoothScroll) {
        this.scrollbar = _smoothScrollbar2.default.init((0, _jquery2.default)('.scrollable').get(0), {
          overscrollEffect: 'bounce'
        });
      } else {
        this.scrollbar = _environment.$window;
      }
    }
  }, {
    key: 'reset',
    value: function reset(keepScroll) {
...
},{"../utils/environment":37,"smooth-scrollbar":25}],35:[function(require,module,exports){
'use strict';
...
var _jquerySlimMin = require('jquery.slim.min.js');
...
function DefaultTransition(options) {
    ...
    return _barba2.default.BaseTransition.extend({
        ...
        finish: function finish() {
            ...
            var $el = (0, _jquerySlimMin2.default)(this.newContainer);
...
},{"barba.js":1,"jquery.slim.min.js":20,"utils/environment":37}],36:[function(require,module,exports){
'use strict';
...
var _DefaultTransition = require('transitions/DefaultTransition');
...
var TransitionManager = function () {
  function TransitionManager() {
    ...
    // jQuery ondomready
    (0, _jquerySlimMin2.default)(function () {
      _this.onLoad();
    });

    // Define different page transitions
    _barba2.default.Pjax.getTransition = this.onGetTransition;

    // prevent smooth transitions on admin things
    _barba2.default.Pjax.originalPreventCheck = _barba2.default.Pjax.preventCheck;
    _barba2.default.Pjax.preventCheck = this.onPreventCheck;

    // add event listeners to barba.js
    _barba2.default.Dispatcher.on('linkClicked', this.onLinkClicked);
    _barba2.default.Dispatcher.on('newPageReady', this.onNewPageReady);
  ...
  _createClass(TransitionManager, [{
    ...
    value: function initForms() {
      (0, _jquerySlimMin2.default)('form[method="get"]').submit(this.onFormSubmit);
    }
  }, {
    key: 'onFormSubmit',
    value: function onFormSubmit(event) {
      // serialize input fields and add them to action url
      var keys = (0, _jquerySlimMin2.default)(this).serialize();
      var url = (0, _jquerySlimMin2.default)(this).get(0).action + '?' + keys;
    ...
    key: 'onPreventCheck',
    value: function onPreventCheck(event, element) {
      // do original check
      if (!_barba2.default.Pjax.originalPreventCheck(event, element)) {
        return false;
      }

      // exclude drupal and wordpress admin links
      var exclude_paths = ['admin\/', 'devel\/', '\/add', '\/edit', '\/logout', 'wpadmin'];

      var exclude_re = new RegExp(exclude_paths.join("|"), "i");
    ...
    key: 'onGetTransition',
    value: function onGetTransition() {
    ...
    key: 'onLinkClicked',
    value: function onLinkClicked(HTMLElement, MouseEvent) {
    ...
    key: 'onNewPageReady',
    value: function onNewPageReady(currentStatus, prevStatus, container, currentHTML) {
      ...
      var response = currentHTML.replace(/(<\/?)body( .+?)?>/gi, '$1notbody$2>', currentHTML);
      var bodyClasses = (0, _jquerySlimMin2.default)(response).filter('notbody').attr('class');
      _environment.$body.attr('class', bodyClasses);
...
},{"barba.js":1,"jquery.slim.min.js":20,"transitions/DefaultTransition":35,"utils/environment":37}],37:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.isDebug = exports.$body = exports.$html = exports.$window = exports.$document = exports.DATA_API_KEY = exports.APP_NAME = undefined;
...
var $document = (0, _jquerySlimMin2.default)(document);
var $window = (0, _jquerySlimMin2.default)(window);
var $html = (0, _jquerySlimMin2.default)(document.documentElement).removeClass('has-no-js').addClass('has-js');
var $body = (0, _jquerySlimMin2.default)(document.body);
